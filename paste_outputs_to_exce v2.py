...
for sheet_name in junctions:
    ...
    list_of_new_junction_coding[sheet_name] = content_to_save
for sheet_name in junctions:
    try:
        ...
        cell_address = f"{start_column}{start_row}"
        wb_sheet.range(cell_address).value = list_of_new_junction_coding[sheet_name] #line.strip()  # Stripping newline characters if needed
